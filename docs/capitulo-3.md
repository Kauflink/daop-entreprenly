...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      Dado que el usuario está en la sección de lotes, cuando ingrese datos inválidos y presione "Agregar", entonces saldrá un mensaje de error por campo obligatorio.
    </td>
    <td>Epic-01</td>
  </tr>
  <!-- US 04 -->
